...
function Mantenimientos() {
    ...
    async function guardarMantenimiento(e) {
        ...
        const mantenimiento = {
            ...
            estado,
            costo: Number(costo),
            activo: 1 // Guardamos como 1 (true en MySQL)
        }
    ...
    async function eliminarMantenimiento(id) {
        ...
        try {
            // Enviamos la petición PUT hacia la subruta de desactivación
            ...
            if (resultado.ok) {
                // Si el backend responde exitosamente, refrescamos la vista inmediatamente
                obtenerMantenimientos()
            } else {
                alert('No se pudo dar de baja en el servidor: ' + resultado.error)
            }
        } catch (error) {
